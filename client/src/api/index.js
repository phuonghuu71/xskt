...
export const fetchProvinces = (page) =>
    axios.get(`${url_province}?_page=${page}`);
...
export const fetchLotteries = (province, date) =>
    axios.get(`${url_lottery}?province=${province}&date=${date}`);
